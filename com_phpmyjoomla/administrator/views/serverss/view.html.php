 ...
 * @since  1.6
 */
class PhpmyjoomlaViewServerss extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_PHPMYJOOMLA_TITLE_SERVERSS'), 'serverss.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('serverss.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
